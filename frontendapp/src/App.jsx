...
export default function UserManager() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get("http://localhost:2030/springbootuserapi/users/display");
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:2030/springbootuserapi/users/add", formData);
